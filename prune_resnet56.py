...
#         prune_prob = [0.6, 0.5, 0.5]
        ...
        skip = [16, 18, 20, 34, 38, 54]
        prune_prob = [0.6, 0.4, 0.6]
    elif args.prune_cfg == 3:
        skip = [16, 18, 20, 34, 38, 54]
        prune_prob = [0.8, 0.8, 0.8]
    else:
    ...
    if args.metric == 'spec':
        ...
        network = prune_resnet56(args, network, skip, prune_prob, prune_eigvs, rev=rev_flag)
    ...
    ###################################################
        ...
        network = prune_resnet56(args, network, skip, prune_prob, prune_nucs, rev=rev_flag)
    ...
    ###################################################  
        ...
        network = prune_resnet56(args, network, skip, prune_prob, prune_fros, rev=rev_flag)
